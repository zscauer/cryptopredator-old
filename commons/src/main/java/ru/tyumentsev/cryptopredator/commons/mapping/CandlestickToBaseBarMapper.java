...
public class CandlestickToBaseBarMapper {
    ...
    public static List<Bar> map(Collection<? extends Candle> candlesticks, CandlestickInterval interval) {
    ...
    public static List<Candlestick> deMap(Collection<Bar> bars) {
